            ...
            <form method="POST">
              <div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="ChannelName" name="ChannelName" value="<?=$Data["ChannelName"]?>">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          ...
                          for($i=0;$i<count($Cats);$i++){
                            ...
                            ?>
                            <option <?=$Selected?> value="<?=$Cats[$i]["CatID"]?>"><?=$Cats[$i]["CatName"]?></option>
                            <?
                          }
                          ?>
                          </select>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="Manifest" name="Manifest" value="<?=$Data["Manifest"]?>">
                        </div>
                      </div>
                      <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="PlaylistLimit" name="PlaylistLimit" value="<?=$Data["PlaylistLimit"]?>">
                        </div>
                      </div>
                      <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <textarea class="form-control" id="AllowedIP" name="AllowedIP"><?=$Data["AllowedIP"]?></textarea>
                        </div>
                      </div>                      
                      <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          ...
                          <input id="SaveRestart" name="SaveRestart" type="submit" class="btn btn-secondary waves-effect waves-light" value="Save & Restart">
                ...
                <div class="col-lg-6">
                  <div class="card">
                    <div class="card-body">
                      <a href="javascript: void(0)" style="float:right" onclick="TestChan()" class="btn btn-outline-warning waves-effect btn-label waves-light"><i class="bx bx-crosshair label-icon"></i> Parse MPD</a>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10" id="TestResult">
                          <div id="Delay" style="font-family: monospace;color:orange">[Parse MPD] to get latest values. Also check [Joiner] value</div>
                        </div>
                      </div>
                      <div class="mb-3 row">
                        ...
                        for($i=0;$i<count($Variants);$i++){
                          ...
                          <label for="AudioID_<?=$Variants[$i]["AudioID"]?>">
                            <input <?=$Checked?> type="checkbox" name="AudioIDs[]" id="AudioID_<?=$Variants[$i]["AudioID"]?>" value="<?=$Variants[$i]["AudioID"]?>"> <?=$Variants[$i]["AudioID"]?>
                          </label><br>
                          <?php
                        }
                        ?>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <select class="form-select" id="VideoID" name="VideoID">
                            ...
                            ?>
                                <option <?=$Selected?> value="<?=$Data["VideoIDs"][$i][0]?>"><?=$Data["VideoIDs"][$i][0]?></option>
                            <?php
                              }
                            }
                            ?>
        ...
        .done(function (data){
          if(data){
            ...
            for(i=0;i<a.length;i++){
              ...
              op+='<label for="AudioID_'+a[i]+'"><input type="checkbox" name="AudioIDs[]" id="AudioID_'+a[i]+'" value="'+a[i]+'"> '+a[i]+'</label><br>';
            }
            $('#AudioIDs').html(op);
            ...
            for(i=0;i<v.length;i++){
              if(v[i] == oldvid)selected='selected';else selected='';
